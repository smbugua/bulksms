  ...
  <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="contacts.php">Address Book</a>
                        </li>
                        <li class="active">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form action="contactadd.php"  method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                              <label>Tel No</label>
                              <input type="number" name="no" class="form-control" required="" placeholder="+254720XXXXXX"> 
                              
                            </div>
                             
                                      <div class="form-group"><label>Choose Database</label>
                                         <?php
                                         $result=mysql_query("SELECT id,name FROM groups Order by id asc");
